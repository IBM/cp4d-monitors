---
title: Cloud Pak for Data Cognos Analytic Connections Information
---
...
- [Cloud Pak Deployer](/monitors/cp4d-cognos-connections-info/deployer) 
- [Manual Deployment using oc commands](/monitors/cp4d-cognos-connections-info/manual)

## Monitor Source

Source folder containing the script can be found  [here (cp4d-cognos-connections-info).](https://github.ibm.com/CloudPakDeployer/cloud-pak-deployer-monitors/tree/master/cp4d-cognos-connections-info) 
...
|:----------|:-------------|:------|:----------|
| Cloud Pak for Data Cognos Analytic Connections Information |Count of Cloud Pak for Data Cognos Analytic Connections |info| The Cloud Pak for Data Cognos Analytic connections information is requested. |
...
**Actual Result metrics:**
- cp4d_cognos_connections_count
  Provides count of Cloud Pak for Data Cognos Analytic Connections
