---
title: Manual Deployment of Cognos Analytic Connections Information
---

This page will go through all manual steps to deploy the Cognos Analytic Connections Information monitor, and in addition to delete it. 
...
## Deploy Cognos Analytic Connection Information
...
NAME                                                   SCHEDULE       SUSPEND   ACTIVE   LAST SCHEDULE   AGE
cp4dplatformcognosconnectionsinfo-cronjob          */15 * * * *   False     0        <none>          10s
```
...
```
export CP4D_PROJECT=<CP4D_PROJECT>
export CP4D_CRONJOB=cp4dplatformcognosconnectionsinfo-cronjob
