...
Source folder containing the script can be found  [here (cp4d-cognos-task-info).](https://github.ibm.com/CloudPakDeployer/cloud-pak-deployer-monitors/tree/master/cp4d-cognos-task-info) 
