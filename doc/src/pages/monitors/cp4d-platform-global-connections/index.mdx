...
Source folder containing the script can be found  [here (cp4d-platform-global-connections).](https://github.ibm.com/CloudPakDeployer/cloud-pak-deployer-monitors/tree/master/cp4d-platform-global-connections) 
