...
Create a secret to access the Git Source repository
...
Acquire the Password for influxdb
```
oc get secret dsx-influxdb-auth -o yaml
```
Copy the base64 encoded "influxdb-password"
```
base64 -d <base64 encoded data>
```
