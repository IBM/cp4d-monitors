...
Source folder containing the script can be found  [here (cp4d-watsonstudio-job-schedule-info).](https://github.ibm.com/CloudPakDeployer/cloud-pak-deployer-monitors/tree/master/cp4d-watsonstudio-job-schedule-info) 
