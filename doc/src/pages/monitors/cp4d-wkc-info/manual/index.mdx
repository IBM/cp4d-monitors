---
title: Manual Deployment of Watson Knowledge Catalog Information
---
...
NAME                                                  SCHEDULE       SUSPEND   ACTIVE   LAST SCHEDULE   AGE
cp4dplatformwatsonknowledgecataloginfo-cronjob   */15 * * * *   False     0        <none>          3s
```
...
```
export CP4D_PROJECT=<CP4D_PROJECT>
export CP4D_CRONJOB=cp4dplatformwatsonknowledgecataloginfo-cronjob
