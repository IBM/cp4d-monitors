...
Source folder containing the script can be found  [here (cp4d-wml-deployment-space-info).](https://github.ibm.com/CloudPakDeployer/cloud-pak-deployer-monitors/tree/master/cp4d-wml-deployment-space-info)
...
**Actual Result metrics:**
- cp4d_wml_deployment_space_info_overall_count
