---
title: Deployment of Watson Machine Learning Deployment Space Job Information using the IBM Cloud Pak Deployer
---
...
- name: cp4d-monitor-set-1
  ...
  - name: cp4d-platform-wml-deployment-space-job-info
    ...
    - name: "cp4d_wml_deployment_space_job_last_status"
      simple_name: "Watson Mechine Learning Deployment Space Job Last Status"
      alert_type: "platform"
      short_description: "CP4D Watson Mechine Learning Deployment Space Job Last Status"
      long_description: "CP4D Watson Mechine Learning Deployment Space Job Last Status: <cp4d_wml_deployment_space_job_last_status_success>"
      resolution: "none"
      reason_code_prefix: "80"  
```
